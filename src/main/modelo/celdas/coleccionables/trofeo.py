...
class Trofeo(Celda):
    "Clase para un trofeo coleccionable dentro de un nivel."
    ...
    def recolectar(self) -> None:
        "Marcar este trofeo como recolectado."

        self.recolectado = True
        self.visible = False
        ev_post(Event(EventosSonidos.TROFEO))
